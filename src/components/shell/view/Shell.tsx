      ...
      <div className="relative flex-1 overflow-hidden p-2">
        ...
        {isScrolledUp && isConnected && (
          <button
            ...
            title={t('shell.scrollToBottom')}
            className="absolute bottom-4 right-4 z-20 flex h-8 w-8 items-center justify-center rounded-full bg-gray-700/90 text-gray-200 shadow-lg transition-colors hover:bg-gray-600"
          >
            <svg
